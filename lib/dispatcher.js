...
//            io.set('transports', ['websocket', 'htmlfile', 'xhr-polling', 'jsonp-polling']);
            ...
            if (hidden.mongo_storage) {
                ...
                var pub = redis.createClient(hidden.redis.port, hidden.redis.url);
                var sub = redis.createClient(hidden.redis.port, hidden.redis.url);
                var client = redis.createClient(hidden.redis.port, hidden.redis.url);
